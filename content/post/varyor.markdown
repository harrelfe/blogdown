...
```r
rexv <- var(plogis(predict(f, type='fitted'))) /
        var(plogis(predict(g, type='fitted')))
rexv
```
...
## Discussion
Add your comments, suggestions, and criticisms on [datamethods.org](https://datamethods.org/t/discussion-of-assessing-heterogeneity-of-treatment-effect-estimating-patient-specific-efficacy-and-studying-variation-in-odds-ratios-risk-ratios-and-risk-differences)
