...
* I heard about a paper showing that variance of active arm continuous responses was not greater than the variance of control arm, in a meta analysis of lots of studies.  I'd like the reference for that.
