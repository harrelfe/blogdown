...
♦ To do the repetitions, you must know the exact design and sampling plan that was in effect for your study. [It's not even clear that one would <em>want</em> to use the same <em>sample size</em> in repeating a study.]
