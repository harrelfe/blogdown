---
title: 'Continuous Learning from Data: No Multiplicities from Computing and Using
  Bayesian Posterior Probabilities as Often as Desired'
...
```{r setup}
require(rms)
knitrSet(lang='markdown',w=7,h=5,echo=TRUE,fig.path='png/')
gmu  <- htmlGreek('mu')
